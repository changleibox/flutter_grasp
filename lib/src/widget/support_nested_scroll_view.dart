...
class SupportNestedScrollViewState extends State<SupportNestedScrollView> {
  ...
  @override
  Widget build(BuildContext context) {
    final _scrollPhysics = widget.physics?.applyTo(const ClampingScrollPhysics()) ??
...
class _NestedScrollPosition extends ScrollPosition implements ScrollActivityDelegate {
  ...
  double applyClampedDragUpdate(double delta) {
    ...
    final newPixels = (pixels - delta).clamp(min, max);
  ...
  bool applyContentDimensions(double minScrollExtent, double maxScrollExtent) {
    ...
    final outerMaxScrollExtent = outerPosition?.hasContentDimensions == true ? outerPosition?.maxScrollExtent : null;
