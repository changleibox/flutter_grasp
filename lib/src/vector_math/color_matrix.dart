...
///
/// 颜色矩阵，这是一个仿写android和系统内置[Matrix4]的colorMatrix，详情请阅读源码@immutable
@immutable
class ColorMatrix {
  /// [Matrix4]
  factory ColorMatrix(
  ...
  /// [Matrix4]
  const ColorMatrix.fromFloat64List(this._m5storage);
...
class Vector5 {
  ...
  const Vector5.fromFloat64List(this._v5storage);
